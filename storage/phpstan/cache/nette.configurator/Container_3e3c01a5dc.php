...
class Container_3e3c01a5dc extends _PHPStan_77a324412\Nette\DI\Container
{
	protected $tags = [
		'phpstan.rules.rule' => [
			'029' => true,
	...
	public function createService0445(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_3e3c01a5dc $container)
			{
	...
	public function createServiceContainer(): Container_3e3c01a5dc
	{
		return $this;
	}
