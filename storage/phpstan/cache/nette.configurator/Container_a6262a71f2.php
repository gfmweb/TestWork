...
class Container_a6262a71f2 extends _PHPStan_77a324412\Nette\DI\Container
{
	protected $tags = [
		'phpstan.rules.rule' => [
			'029' => true,
	...
	public function createService0445(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_a6262a71f2 $container)
			{
	...
	public function createServiceContainer(): Container_a6262a71f2
	{
		return $this;
	}
