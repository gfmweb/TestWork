...
class Container_8e848cef88 extends _PHPStan_77a324412\Nette\DI\Container
{
	protected $tags = [
		'phpstan.rules.rule' => [
			'029' => true,
	...
	protected $types = ['container' => '_PHPStan_77a324412\Nette\DI\Container'];
	protected $aliases = [];

	protected $wiring = [
		'_PHPStan_77a324412\Nette\DI\Container' => [['container']],
		'PHPStan\Rules\Rule' => [
			[
				'029',
				'030',
	...
	public function createService0445(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_8e848cef88 $container)
			{
	...
	public function createServiceContainer(): Container_8e848cef88
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 5,
			'paths' => ['/var/www/html/app', '/var/www/html/config', '/var/www/html/database', '/var/www/html/routes'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'env' => [
				...
				'APP_ENV' => 'local',
				'APP_KEY' => 'base64:60/3BctYdVHbfIWhiEGJ7TYYq43XnAsQ9NuXraaSdTk=',
				'DB_PASSWORD' => 'root',
